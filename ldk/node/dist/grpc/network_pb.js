...
proto.proto.HTTPRequestMsg.prototype.getHeadersMap = function (opt_noLazyCreate) {
    return /** @type {!jspb.Map<string,!proto.proto.HTTPHeader>} */ (jspb.Message.getMapField(this, 5, opt_noLazyCreate, proto.proto.HTTPHeader));
};
/**
...
proto.proto.HTTPResponseMsg.prototype.getHeadersMap = function (opt_noLazyCreate) {
    return /** @type {!jspb.Map<string,!proto.proto.HTTPHeader>} */ (jspb.Message.getMapField(this, 3, opt_noLazyCreate, proto.proto.HTTPHeader));
};
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.proto.HTTPResponseMsg} returns this
