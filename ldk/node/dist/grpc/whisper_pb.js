...
goog.exportSymbol('proto.proto.WhisperListElement.Alert', null, global);
goog.exportSymbol('proto.proto.WhisperListElement.Alert.Highlight', null, global);
...
goog.exportSymbol('proto.proto.WhisperListElement.Pair.Highlight', null, global);
 ...
 * @constructor
 */
proto.proto.WhisperListElement.Alert = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.WhisperListElement.Alert, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    /**
     * @public
     * @override
     */
    proto.proto.WhisperListElement.Alert.displayName = 'proto.proto.WhisperListElement.Alert';
}
 ...
 * @const
 */
proto.proto.WhisperListElement.oneofGroups_ = [[3, 4]];
/**
 * @enum {number}
 */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.proto.WhisperListElement.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            alert: (f = msg.getAlert()) && proto.proto.WhisperListElement.Alert.toObject(includeInstance, f)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
    ...
    while (reader.nextField()) {
        ...
        switch (field) {
            ...
            case 3:
                ...
                break;
            case 4:
                var value = new proto.proto.WhisperListElement.Alert;
                reader.readMessage(value, proto.proto.WhisperListElement.Alert.deserializeBinaryFromReader);
                msg.setAlert(value);
                break;
            default:
                reader.skipField();
...
proto.proto.WhisperListElement.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getPair();
    if (f != null) {
        writer.writeMessage(3, f, proto.proto.WhisperListElement.Pair.serializeBinaryToWriter);
    }
    f = message.getAlert();
    if (f != null) {
        writer.writeMessage(4, f, proto.proto.WhisperListElement.Alert.serializeBinaryToWriter);
    }
};
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
    ...
    while (reader.nextField()) {
        ...
        switch (field) {
            ...
            case 2:
                ...
                break;
            case 3:
                var value = /** @type {!proto.proto.WhisperListElement.Pair.Highlight} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.proto.WhisperListElement.Pair.Highlight = {
    NONE: 0,
    YELLOW: 1
};
/**
 ...
 * @return {string}
 */
proto.proto.WhisperListElement.Pair.prototype.getKey = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
/**
 * @param {string} value
 ...
 */
proto.proto.WhisperListElement.Pair.prototype.setKey = function (value) {
    return jspb.Message.setProto3StringField(this, 1, value);
};
/**
 ...
 * @return {!proto.proto.WhisperListElement.Pair.Highlight}
 */
proto.proto.WhisperListElement.Pair.prototype.getHighlight = function () {
    return /** @type {!proto.proto.WhisperListElement.Pair.Highlight} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
/**
 * @param {!proto.proto.WhisperListElement.Pair.Highlight} value
 * @return {!proto.proto.WhisperListElement.Pair} returns this
 */
proto.proto.WhisperListElement.Pair.prototype.setHighlight = function (value) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
     ...
     * @return {!Object}
     */
    proto.proto.WhisperListElement.Alert.prototype.toObject = function (opt_includeInstance) {
        return proto.proto.WhisperListElement.Alert.toObject(opt_includeInstance, this);
    };
    /**
     * Static version of the {@see toObject} method.
     * @param {boolean|undefined} includeInstance Deprecated. Whether to include
     *     the JSPB instance for transitional soy proto support:
     *     http://goto/soy-param-migration
     * @param {!proto.proto.WhisperListElement.Alert} msg The msg instance to transform.
     * @return {!Object}
     * @suppress {unusedLocalVariables} f is only used for nested messages
     */
    proto.proto.WhisperListElement.Alert.toObject = function (includeInstance, msg) {
        var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.WhisperListElement.Alert}
 */
proto.proto.WhisperListElement.Alert.deserializeBinary = function (bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.proto.WhisperListElement.Alert;
    return proto.proto.WhisperListElement.Alert.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.WhisperListElement.Alert} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.WhisperListElement.Alert}
 */
proto.proto.WhisperListElement.Alert.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
        if (reader.isEndGroup()) {
            break;
        }
        ...
        switch (field) {
            case 1:
                ...
                break;
            case 2:
                var value = /** @type {!proto.proto.WhisperListElement.Alert.Highlight} */ (reader.readEnum());
                msg.setHighlight(value);
                break;
            default:
                reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.proto.WhisperListElement.Alert.prototype.serializeBinary = function () {
    var writer = new jspb.BinaryWriter();
    proto.proto.WhisperListElement.Alert.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.WhisperListElement.Alert} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.WhisperListElement.Alert.serializeBinaryToWriter = function (message, writer) {
    var f = undefined;
    f = message.getBody();
    if (f.length > 0) {
        writer.writeString(1, f);
 ...
 * @enum {number}
 */
proto.proto.WhisperListElement.Alert.Highlight = {
    NONE: 0,
    RED: 1,
    GREEN: 2
};
 ...
 * @return {string}
 */
proto.proto.WhisperListElement.Alert.prototype.getBody = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
/**
 * @param {string} value
 * @return {!proto.proto.WhisperListElement.Alert} returns this
 */
proto.proto.WhisperListElement.Alert.prototype.setBody = function (value) {
    return jspb.Message.setProto3StringField(this, 1, value);
};
/**
 * optional Highlight highlight = 2;
 * @return {!proto.proto.WhisperListElement.Alert.Highlight}
 */
proto.proto.WhisperListElement.Alert.prototype.getHighlight = function () {
    return /** @type {!proto.proto.WhisperListElement.Alert.Highlight} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
/**
 * @param {!proto.proto.WhisperListElement.Alert.Highlight} value
 * @return {!proto.proto.WhisperListElement.Alert} returns this
 */
proto.proto.WhisperListElement.Alert.prototype.setHighlight = function (value) {
...
proto.proto.WhisperListElement.prototype.getPair = function () {
    return /** @type{?proto.proto.WhisperListElement.Pair} */ (jspb.Message.getWrapperField(this, proto.proto.WhisperListElement.Pair, 3));
};
/**
...
proto.proto.WhisperListElement.prototype.setPair = function (value) {
    return jspb.Message.setOneofWrapperField(this, 3, proto.proto.WhisperListElement.oneofGroups_[0], value);
};
/**
 * Clears the message field making it undefined.
 * @return {!proto.proto.WhisperListElement} returns this
 ...
 * @return {?proto.proto.WhisperListElement.Alert}
 */
proto.proto.WhisperListElement.prototype.getAlert = function () {
    return /** @type{?proto.proto.WhisperListElement.Alert} */ (jspb.Message.getWrapperField(this, proto.proto.WhisperListElement.Alert, 4));
};
/**
 * @param {?proto.proto.WhisperListElement.Alert|undefined} value
 * @return {!proto.proto.WhisperListElement} returns this
*/
proto.proto.WhisperListElement.prototype.setAlert = function (value) {
 ...
 * @return {!proto.proto.WhisperListElement} returns this
 */
proto.proto.WhisperListElement.prototype.clearAlert = function () {
 ...
 * @return {boolean}
 */
proto.proto.WhisperListElement.prototype.hasAlert = function () {
    return jspb.Message.getField(this, 4) != null;
};
