...
proto.proto.KeyboardHotkeyStreamRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getHotkey();
    if (f != null) {
        writer.writeMessage(2, f, proto.proto.KeyboardHotkey.serializeBinaryToWriter);
    }
};
/**
...
proto.proto.KeyboardHotkeyStreamRequest.prototype.getHotkey = function () {
    return /** @type{?proto.proto.KeyboardHotkey} */ (jspb.Message.getWrapperField(this, proto.proto.KeyboardHotkey, 2));
};
/**
