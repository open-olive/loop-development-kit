...
const fileSystemSensor_1 = require("./fileSystemSensor");
...
function parseFileAction(action) {
    switch (action) {
        case filesystem_pb_1.FileAction.FILE_ACTION_CREATE:
            return fileSystemSensor_1.FileSystemStreamAction.Create;
        case filesystem_pb_1.FileAction.FILE_ACTION_WRITE:
            return fileSystemSensor_1.FileSystemStreamAction.Write;
        case filesystem_pb_1.FileAction.FILE_ACTION_REMOVE:
            return fileSystemSensor_1.FileSystemStreamAction.Remove;
        case filesystem_pb_1.FileAction.FILE_ACTION_RENAME:
            return fileSystemSensor_1.FileSystemStreamAction.Rename;
        case filesystem_pb_1.FileAction.FILE_ACTION_CHMOD:
            return fileSystemSensor_1.FileSystemStreamAction.Chmod;
        case filesystem_pb_1.FileAction.FILE_ACTION_UNKNOWN:
        default:
            return fileSystemSensor_1.FileSystemStreamAction.Unknown;
    }
}
/**
 * @internal
