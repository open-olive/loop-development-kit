...
const whisperSensor_1 = require("./whisperSensor");
...
exports.generateWhisperListStyle = (style) => {
    switch (style) {
        case whisperSensor_1.WhisperListStyle.NONE: {
            return messages.WhisperListElement.Style.STYLE_NONE;
        }
        case whisperSensor_1.WhisperListStyle.SUCCESS: {
            return messages.WhisperListElement.Style.STYLE_SUCCESS;
        }
        case whisperSensor_1.WhisperListStyle.WARN: {
            return messages.WhisperListElement.Style.STYLE_WARN;
        }
        case whisperSensor_1.WhisperListStyle.ERROR: {
...
exports.generateWhisperListAlign = (align) => {
    switch (align) {
        case whisperSensor_1.WhisperListAlign.LEFT: {
            return messages.WhisperListElement.Align.ALIGN_LEFT;
        }
        case whisperSensor_1.WhisperListAlign.CENTER: {
            return messages.WhisperListElement.Align.ALIGN_CENTER;
        }
        case whisperSensor_1.WhisperListAlign.RIGHT: {
    ...
    switch (element.type) {
        case 'pair': {
            ...
            if (element.style) {
                ...
                inputMsg.setStyle(exports.generateWhisperListStyle(whisperSensor_1.WhisperListStyle.NONE));
            }
        ...
        case 'message': {
            ...
            if (element.align) {
                ...
                inputMsg.setAlign(exports.generateWhisperListAlign(whisperSensor_1.WhisperListAlign.LEFT));
            }
            if (element.body) {
