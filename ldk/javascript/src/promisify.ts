...
export function promisifyMappedWithTwoParams<TParam1, TParam2In, TParam2Out, TInternalOut, TExternalOut>(
	param1: TParam1,
	param2: TParam2In,
	param2Map: Mapper<TParam2In, TParam2Out>,
	map: Mapper<TInternalOut, TExternalOut>,
...
export function promisifyListenable<T>(cb: (v: T) => void, arg: OliveHelps.Listenable<T>): Promise<Cancellable> {
	return new Promise((resolve, reject) => {
		try {
