...
import { whisper } from '..';
import { ldkForms } from './form-parser';
import { mapToInternalWhisper } from './whisper-mapper';
...
describe('form parser', () => {
  describe('parseNewWhisper', () => {
    it('adds all non-form components to outgoing collection', () => {
      ...
      const actual = mapToInternalWhisper(newWhisper);
    ...
    it('initializes form state for each given form', () => {
      ...
      const twoFormWhisper: whisper.NewWhisper = {
        components: [
          {
            children: [expectedFormOneChild],
            onSubmit: jest.fn(),
            type: whisper.WhisperComponentType.Form,
          },
          {
            children: [expectedFormTwoChild],
            onSubmit: jest.fn(),
            type: whisper.WhisperComponentType.Form,
          },
        ],
      ...
      mapToInternalWhisper(twoFormWhisper);
