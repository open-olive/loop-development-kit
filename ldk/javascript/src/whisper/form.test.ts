...
describe('Form', () => {
  it('updates component state for given components upon change', () => {
    ...
    (ldkForm.children[0] as TextInput).onChange(undefined, expectedTextInputValue, {
      id: '',
      close: jest.fn(),
      update: jest.fn(),
    });
    ...
    (ldkForm.children[1] as Telephone).onChange(undefined, expectedTelephoneInputValue, {
      id: '',
      close: jest.fn(),
      update: jest.fn(),
    });
    ...
    (ldkForm.children[2] as Select).onSelect(undefined, expectedSelectInputValue, {
      id: '',
      close: jest.fn(),
      update: jest.fn(),
    });
    ...
    expect(ldkForm.getComponentState().get(telephoneInputComponentName)).toBe(
      expectedTelephoneInputValue,
    );
  ...
  it('forwards calls to provided onChange after updating component state', () => {
    ...
    (ldkForm.children[0] as TextInput).onChange(
      expectedError,
  ...
  it('initializes component state with provided value', () => {
    ...
    expect(ldkForm.getComponentState().get(textInputComponentName)).toBe(
      expectedTextInputInitialValue,
    );
  ...
  it('replaces duplicate component names and stores last onChange value', () => {
    ...
    const expectedTelephoneInputValue = '330-614-1234';
    (ldkForm.children[1] as TextInput).onChange(undefined, expectedTelephoneInputValue, {
      id: '',
      close: jest.fn(),
      update: jest.fn(),
    });
    ...
    expect(ldkForm.getComponentState().get(duplicateComponentName)).toBe(
      expectedTelephoneInputValue,
    );
  });
