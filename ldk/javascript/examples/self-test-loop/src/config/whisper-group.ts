...
export const whisperTestGroup = (): TestGroup =>
  new TestGroup('Whisper Aptitude', [
    ...
    new LoopTest(
      'Whisper Aptitude - Dropzone',
      whisperTests.testDropzone,
      30000,
      'Select files for the dropzone',
    ),
    new LoopTest(
    ...
    new LoopTest(
      'Whisper Aptitude - Flex whisper',
      whisperTests.testFlex,
      20000,
      'Click the right button',
    ),
    new LoopTest(
      'Whisper Aptitude - Flex whisper properties',
    ...
    new LoopTest(
      'Whisper Aptitude - Pagination',
      whisperTests.testPagination,
      30000,
      'Do all of the paginated sections work correctly?',
    ),
    new LoopTest(
