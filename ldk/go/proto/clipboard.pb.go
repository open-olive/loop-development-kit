...
var file_clipboard_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2b, 0x0a, 0x15, 0x43, 0x6c, 0x69, 0x70, 0x62, 0x6f, 0x61,
	0x72, 0x64, 0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12,
	0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x65,
	0x78, 0x74, 0x22, 0x47, 0x0a, 0x1b, 0x43, 0x6c, 0x69, 0x70, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x52,
	...
	,
	...
	0x30, 0x01, 0x12, 0x46, 0x0a, 0x0e, 0x43, 0x6c, 0x69, 0x70, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x57,
	0x72, 0x69, 0x74, 0x65, 0x12, 0x1c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x43, 0x6c, 0x69,
	0x70, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x57, 0x72, 0x69, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
...
var file_clipboard_proto_goTypes = []interface{}{
	(*ClipboardReadResponse)(nil),       // 0: proto.ClipboardReadResponse
	(*ClipboardReadStreamResponse)(nil), // 1: proto.ClipboardReadStreamResponse
	(*ClipboardWriteRequest)(nil),       // 2: proto.ClipboardWriteRequest
	(*empty.Empty)(nil),                 // 3: google.protobuf.Empty
}
var file_clipboard_proto_depIdxs = []int32{
	3, // 0: proto.Clipboard.ClipboardRead:input_type -> google.protobuf.Empty
	3, // 1: proto.Clipboard.ClipboardReadStream:input_type -> google.protobuf.Empty
	2, // 2: proto.Clipboard.ClipboardWrite:input_type -> proto.ClipboardWriteRequest
	0, // 3: proto.Clipboard.ClipboardRead:output_type -> proto.ClipboardReadResponse
	1, // 4: proto.Clipboard.ClipboardReadStream:output_type -> proto.ClipboardReadStreamResponse
	3, // 5: proto.Clipboard.ClipboardWrite:output_type -> google.protobuf.Empty
...
type ClipboardClient interface {
	...
	ClipboardRead(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ClipboardReadResponse, error)
	// get the contents of the clipboard every time they change
	ClipboardReadStream(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Clipboard_ClipboardReadStreamClient, error)
...
func (c *clipboardClient) ClipboardRead(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ClipboardReadResponse, error) {
...
func (c *clipboardClient) ClipboardReadStream(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Clipboard_ClipboardReadStreamClient, error) {
...
type ClipboardServer interface {
	// get the contents of the clipboard
	ClipboardRead(context.Context, *empty.Empty) (*ClipboardReadResponse, error)
	// get the contents of the clipboard every time they change
	ClipboardReadStream(*empty.Empty, Clipboard_ClipboardReadStreamServer) error
	// write to the clipboard
...
func (*UnimplementedClipboardServer) ClipboardRead(context.Context, *empty.Empty) (*ClipboardReadResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ClipboardRead not implemented")
}
func (*UnimplementedClipboardServer) ClipboardReadStream(*empty.Empty, Clipboard_ClipboardReadStreamServer) error {
...
func _Clipboard_ClipboardRead_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClipboardServer).ClipboardRead(ctx, req.(*empty.Empty))
	}
