...
type HTTPRequestMsg struct {
	...
	TimeoutMs int64                  `protobuf:"varint,6,opt,name=timeoutMs,proto3" json:"timeoutMs,omitempty"`
}
...
func (x *HTTPRequestMsg) GetTimeoutMs() int64 {
	if x != nil {
		return x.TimeoutMs
	}
	return 0
...
var file_network_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74,
