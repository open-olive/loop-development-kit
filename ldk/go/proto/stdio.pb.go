...
func (StdioData_Channel) Descriptor() protoreflect.EnumDescriptor {
	return file_stdio_proto_enumTypes[0].Descriptor()
}

func (StdioData_Channel) Type() protoreflect.EnumType {
	return &file_stdio_proto_enumTypes[0]
}
...
func (StdioData_Channel) EnumDescriptor() ([]byte, []int) {
	return file_stdio_proto_rawDescGZIP(), []int{0, 0}
}
...
type StdioData struct {
	...
	Channel StdioData_Channel `protobuf:"varint,1,opt,name=channel,proto3,enum=proto.StdioData_Channel" json:"channel,omitempty"`
...
func (x *StdioData) Reset() {
	*x = StdioData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_stdio_proto_msgTypes[0]
...
func (*StdioData) Descriptor() ([]byte, []int) {
	return file_stdio_proto_rawDescGZIP(), []int{0}
}
...
var File_stdio_proto protoreflect.FileDescriptor

var file_stdio_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x73, 0x74, 0x64, 0x69, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1b, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x22, 0x83, 0x01, 0x0a, 0x09, 0x53, 0x74, 0x64, 0x69, 0x6f, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x32, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74, 0x64, 0x69, 0x6f, 0x44, 0x61,
	...
	0x54, 0x44, 0x45, 0x52, 0x52, 0x10, 0x02, 0x32, 0x46, 0x0a, 0x09, 0x47, 0x52, 0x50, 0x43, 0x53,
	0x74, 0x64, 0x69, 0x6f, 0x12, 0x39, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x74,
	...
	0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74, 0x64, 0x69, 0x6f, 0x44, 0x61, 0x74, 0x61, 0x30, 0x01, 0x42,
	0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	file_stdio_proto_rawDescOnce sync.Once
	file_stdio_proto_rawDescData = file_stdio_proto_rawDesc
)

func file_stdio_proto_rawDescGZIP() []byte {
	file_stdio_proto_rawDescOnce.Do(func() {
		file_stdio_proto_rawDescData = protoimpl.X.CompressGZIP(file_stdio_proto_rawDescData)
	})
	return file_stdio_proto_rawDescData
}

var file_stdio_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_stdio_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_stdio_proto_goTypes = []interface{}{
	(StdioData_Channel)(0), // 0: proto.StdioData.Channel
	(*StdioData)(nil),      // 1: proto.StdioData
	(*empty.Empty)(nil),    // 2: google.protobuf.Empty
}
var file_stdio_proto_depIdxs = []int32{
	0, // 0: proto.StdioData.channel:type_name -> proto.StdioData.Channel
	2, // 1: proto.GRPCStdio.StreamStdio:input_type -> google.protobuf.Empty
	1, // 2: proto.GRPCStdio.StreamStdio:output_type -> proto.StdioData
...
func init() { file_stdio_proto_init() }
func file_stdio_proto_init() {
	if File_stdio_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_stdio_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_stdio_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_stdio_proto_goTypes,
		DependencyIndexes: file_stdio_proto_depIdxs,
		EnumInfos:         file_stdio_proto_enumTypes,
		MessageInfos:      file_stdio_proto_msgTypes,
	}.Build()
	File_stdio_proto = out.File
	file_stdio_proto_rawDesc = nil
	file_stdio_proto_goTypes = nil
	file_stdio_proto_depIdxs = nil
}
...
func (c *gRPCStdioClient) StreamStdio(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (GRPCStdio_StreamStdioClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GRPCStdio_serviceDesc.Streams[0], "/proto.GRPCStdio/StreamStdio", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedGRPCStdioServer can be embedded to have forward compatible implementations.
type UnimplementedGRPCStdioServer struct {
}

func (*UnimplementedGRPCStdioServer) StreamStdio(*empty.Empty, GRPCStdio_StreamStdioServer) error {
