...
var file_cursor_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x4c, 0x0a, 0x16, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x50, 0x6f, 0x73, 0x69,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x01, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x63, 0x72, 0x65,
	0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x73, 0x63, 0x72, 0x65, 0x65, 0x6e,
	0x22, 0x68, 0x0a, 0x1c, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69,
	...
	,
...
var file_cursor_proto_goTypes = []interface{}{
	(*CursorPositionResponse)(nil),       // 0: proto.CursorPositionResponse
	(*CursorPositionStreamResponse)(nil), // 1: proto.CursorPositionStreamResponse
	(*empty.Empty)(nil),                  // 2: google.protobuf.Empty
}
var file_cursor_proto_depIdxs = []int32{
	2, // 0: proto.Cursor.CursorPosition:input_type -> google.protobuf.Empty
	2, // 1: proto.Cursor.CursorPositionStream:input_type -> google.protobuf.Empty
	0, // 2: proto.Cursor.CursorPosition:output_type -> proto.CursorPositionResponse
	1, // 3: proto.Cursor.CursorPositionStream:output_type -> proto.CursorPositionStreamResponse
...
type CursorClient interface {
	...
	CursorPosition(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CursorPositionResponse, error)
	// get the position of the cursor every time it changes
	CursorPositionStream(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Cursor_CursorPositionStreamClient, error)
}
...
func (c *cursorClient) CursorPosition(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CursorPositionResponse, error) {
...
func (c *cursorClient) CursorPositionStream(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Cursor_CursorPositionStreamClient, error) {
...
type CursorServer interface {
	// get the current position of the cursor
	CursorPosition(context.Context, *empty.Empty) (*CursorPositionResponse, error)
	// get the position of the cursor every time it changes
	CursorPositionStream(*empty.Empty, Cursor_CursorPositionStreamServer) error
}
...
func (*UnimplementedCursorServer) CursorPosition(context.Context, *empty.Empty) (*CursorPositionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CursorPosition not implemented")
}
func (*UnimplementedCursorServer) CursorPositionStream(*empty.Empty, Cursor_CursorPositionStreamServer) error {
...
func _Cursor_CursorPosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CursorServer).CursorPosition(ctx, req.(*empty.Empty))
	}
